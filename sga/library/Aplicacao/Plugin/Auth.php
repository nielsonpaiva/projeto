...
class Aplicacao_Plugin_Auth extends Zend_Controller_Plugin_Abstract {
	 ...
	 * @var array
	 */
	protected $_notLoggedRoute = array ('controller' => 'login', 'action' => 'login', 'module' => 'admin' );
	/**
	 *
	 * @var array
	 */
	protected $_forbiddenRoute = array ('controller' => 'error', 'action' => 'forbidden', 'module' => 'admin' );
