...
class Admin_Form_AlterarUsuario extends Zend_Form
{
    ...
    public function init()
    {
    	...
    	->addMultiOptions(array(
    			...
    			$this->addElements(array($cpf,$nome,$endereco,$numero,$telefone,$sexo,$data,$email,$profissao,$perfil,$submit,$reset));
    			...
    			$this->setAction('/sga/admin/usuario/alterar');
    }
